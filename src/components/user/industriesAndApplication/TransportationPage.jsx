...
const TransportationPage = () => {
  const heroTitle = "Advancing Transportation Solutions";
  const breadcrumbs = [
    { label: "Home", link: "/" },
    { label: "Industries and Applications", link: "/industries-and-applications" },
    { label: "Transportation", link: "/industries-and-applications/transportation" }
  ];
  ...
  return (
    <PageContainer>
      ...
      <ContentContainer>
        <ContentSection>
          <ContentText>
            The transportation industry demands reliable and efficient solutions to keep the world moving. Raychem RPG provides innovative technologies for rail, aviation, and maritime applications.
          </ContentText>
          <ContentText>
            Our solutions include cable management systems, electrical connectivity, and protective coatings designed to withstand harsh environments. Raychem RPG supports transportation infrastructure with durable and sustainable products.
          </ContentText>
        </ContentSection>
      </ContentContainer>
      <Footer />
